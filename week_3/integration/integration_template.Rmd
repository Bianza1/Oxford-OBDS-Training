...
usethis::use_git_config(user.name = "Bianza Tinotenda Mbavha", user.email = "beeytinoe@gmail.com")
usethis::create_github_token()
#TOKEN = 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 
...
plot_grid(p1, p2, ncol=1, labels = c(p1 ="pbmcv2", p2="ppbmcv3"))
library(cowplot)
...
plot_var <- LabelPoints(plot = plot1, points = top10, repel = TRUE)
plot_var
```
