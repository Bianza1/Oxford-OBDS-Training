...
```{r}
set.seed(1)
norm_values <- rnorm(n=1000, mean = 10, sd = 5)
...
```{r}
quantile(norm_values, seq(0,1 , 0.1))
```

- Visualise the distribution of those values as a histogram.

```{r}
hist(norm_values, breaks = 20)
```
...
hist(norm_values, breaks = 20)
abline(v=mean(norm_values), col = "red")
abline(v=median(norm_values), col = "red", lty ="dashed")
abline(v=mean(norm_values) - sd(norm_values), col = "blue")
abline(v=mean(norm_values) + sd(norm_values), col = "blue", lty = 2)
abline(v=mean(norm_values) + 2*sd(norm_values), col = "green")
...
abline(v=mean(norm_values), col = "red")
abline(v=median(norm_values), col = "red", lty ="dashed")
abline(v=median(norm_values) - sd(norm_values), col = "blue")
abline(v=median(norm_values) - mad(norm_values), col = "blue", lty = 2)
abline(v=median(norm_values) + mad(norm_values), col = "green")
...
```{r}
set.seed(1)
nm <- rnorm(n=1000000, mean=10, sd=5)
hist(nm, breaks = 1000)
```
...
```{r}
qn <- qnorm(seq(0,1 , 0.01))
qn
plot(seq(0,1 , 0.01), qn)
