...
pca_iris_species2 <- ggplot(pca_iris_dataframe, aes(PC1,PC2, color = Species)) +
  geom_point()
pca_iris_species2
...
```{r}
variance_dataframe <- data.frame(explained_variance_ratio,pca = c("pca1", "pca2", "pca3", "pca4")) 
variance_dataframe
...
```{r}
pca_plot <- ggplot(variance_dataframe, aes(pca, explained_variance_ratio, color=pca)) +
