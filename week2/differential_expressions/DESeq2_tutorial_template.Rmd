...
dds_spearman <- cor(assay(rlog_transformed_dds), method="spearman")
dds_pearson <- cor(assay(rlog_transformed_dds), method="pearson")

# use pheatmap to plot the correlation matrix 
pheatmap(dds_spearman)
pheatmap(dds_pearson)
sample_info
```
...
my_pca <- plotPCA(rlog_transformed_dds_subset, intgroup="cell_type") +
    theme(aspect.ratio = 1)
my_pca

# what does the intgroup parameter do? have a go at changing it...
#intgroup replicate
my_pca1 <- plotPCA(rlog_transformed_dds_subset, intgroup="replicate") +
    theme(aspect.ratio = 1)
my_pca1

my_pca3 <- plotPCA(rlog_transformed_dds_subset, intgroup="genotype") +
    theme(aspect.ratio = 1)
my_pca3
...
my_pca2 <- plotPCA(rlog_transformed_dds_subset, intgroup="cell_type", ntop=nrow(rlog_transformed_dds_subset)) +
    theme(aspect.ratio = 1)
my_pca2
```
